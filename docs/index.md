...
That is the whole installation. No server to run, no extension to compile, no second datastore to back up — the graph is ordinary tables in the PostgreSQL you already have. Ten runnable examples live in [`examples/`](https://github.com/crajah/post-graph/tree/main/examples), none of which need an LLM or any service beyond your database.

**[Read the code](https://github.com/crajah/post-graph)** · **[Ten examples](https://github.com/crajah/post-graph/tree/main/examples)** · **[Cypher subset](https://crajah.github.io/post-graph/cypher.html)** · Apache 2.0
